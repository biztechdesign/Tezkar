            ...
            {productMode === "design" ? (
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="relative group/designnow">
                  <button
                    className="w-full flex items-center justify-center gap-2 py-3.5 bg-[#044c5c] text-white hover:!text-white hover:bg-[#033a48] transition-colors text-[12px] uppercase tracking-wider"
