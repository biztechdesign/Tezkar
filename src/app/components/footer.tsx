        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="tel:+97144567890" className="flex items-center gap-2.5 text-white/70 text-[12px] hover:text-[#d41c5c] transition-colors">
                <Phone size={14} className="text-white flex-shrink-0" />
                +971 4 456 7890
              </a>
              <a href="mailto:info@tezkargift.com" className="flex items-center gap-2.5 text-white/70 text-[12px] hover:text-[#d41c5c] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {policies.map((link) => (
                <li key={link}>
                  <a href="#" className="text-white/70 text-[12px] hover:text-[#d41c5c] transition-colors">
                    {link}
                  </a>
                </li>
              ))}
      ...
      <div className="border-t border-white/10 relative z-10" style={{ background: "rgba(4,57,71,0.8)" }}>
        <div className="max-w-[1400px] mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              {socialIcons.map((social) => (
                <a
                  key={social.name}
                  href="#"
                  className="w-9 h-9 bg-white/8 flex items-center justify-center hover:bg-[#d41c5c] transition-colors"
            ...
            <button
              onClick={scrollToTop}
              className="flex items-center gap-1 text-white/60 text-[11px] hover:text-[#d41c5c] transition-colors uppercase tracking-wide"
            >
