...
const PRINT_LOCATIONS = [
  { id: "front-chest", label: "Front Chest", highlight: { x: 40, y: 30, w: 20, h: 14 } },
  { id: "full-front", label: "Full Front", highlight: { x: 28, y: 24, w: 44, h: 54 } },
  { id: "full-back", label: "Full Back", highlight: { x: 28, y: 24, w: 44, h: 54 } },
  { id: "left-chest", label: "Left Chest", highlight: { x: 34, y: 30, w: 12, h: 12 } },
  { id: "right-chest", label: "Right Chest", highlight: { x: 54, y: 30, w: 12, h: 12 } },
  { id: "left-sleeve", label: "Left Sleeve", highlight: { x: 12, y: 22, w: 10, h: 18 } },
  { id: "right-sleeve", label: "Right Sleeve", highlight: { x: 78, y: 22, w: 10, h: 18 } },
  { id: "center-back-yoke", label: "Center Back Yoke", highlight: { x: 42, y: 18, w: 16, h: 10 } },
];
...
function TshirtIcon({
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
      <path
        d="M30 15 L45 8 Q50 14 55 8 L70 15 L88 22 L82 38 L72 34 L72 88 Q72 92 68 92 L32 92 Q28 92 28 88 L28 34 L18 38 L12 22 Z"
        stroke={stroke}
        strokeWidth="2"
      ...
      <section className="max-w-[1400px] mx-auto px-4 md:px-6 pb-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div>
            ...
            {/* Sizes & Quantities — one connected box per size */}
            <div className="mb-8">
              ...
              <div className="grid grid-cols-7 gap-2">
                {SIZE_OPTIONS.map((s) => {
                  ...
                  return (
                    <label
                      key={s}
                      className="flex flex-col items-stretch overflow-hidden cursor-text transition-all"
                      style={{
                        border: active ? "2px solid #044c5c" : "1px solid #E6E8EB",
                        borderRadius: 0,
                    ...
                    >
                      <div
                        className="text-[12px] flex items-center justify-center py-2 font-bold transition-all"
                        style={{
                          fontFamily: "Poppins, sans-serif",
                          color: active ? "#FFFFFF" : "#2C2C2C",
                          backgroundColor: active ? "#044c5c" : "#FAFAF8",
                          borderBottom: active ? "none" : "1px solid #E6E8EB",
                        }}
                      >
                        {s}
                      </div>
                      <input
                        ...
                        className="w-full text-center py-2.5 text-[15px] text-[#2C2C2C] bg-white focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        style={{
                          fontFamily: "Poppins, sans-serif",
