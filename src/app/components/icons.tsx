...
export const ChevronsLeft = makeIcon("fa-angles-left");
export const ChevronsRight = makeIcon("fa-angles-right");
...
export const FilePdf = makeIcon("fa-file-pdf");
export const FileExcel = makeIcon("fa-file-excel");
